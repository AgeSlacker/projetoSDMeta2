...
<div>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col text-left" style="margin-bottom: 38px;"><input
                    placeholder="Digite aqui um novo URL para indexar"
                    style=" border:2px solid black;outline: none;padding-left: 20px; width:60%; height:40px; border-radius:20px;"
                    type="text"></div>
        </div>
        <div class="row">
            <div class="col-md-4">
